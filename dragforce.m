function[Fd,Fd_orb,Fd_tanksrb]=dragforce(ro,v,t,s)
%function to find the drag force acting againts the motion of the rocket
...
%outputs
%Fd=total drag force
%Fd_orb=drag force due to the orbiter
%Fd_tanksrb=drag force due to the external fuel tank and 2 SRBs

%version 1:Author=Eoin Gahan created:10/5/22

%constants
Rsrb=1.4;%Radius of 1 SRB
Rexttank=4.2;%Radius of external tank
Rorb=2;%assumed effective radius of orbiter()
